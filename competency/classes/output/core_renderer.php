    ...
    public function dashboard_matrix()
    {
      ...
      $user_id = $USER->id;
                    ...
                    $maximum = $DB->get_records_sql("SELECT c.id AS cid,
                                          ...
                                          ct.name AS category, u.id AS u_id,
                                    ...
                                    $minimum = $DB->get_record_sql("SELECT c.id AS cid,
                                            ...
                                            $competency = $DB->get_records_sql("SELECT
                                                ...
                                                foreach ($competency as $showcompetency) {
                                                  //get record
                                                  $res1 = $DB->get_record_sql("SELECT shortname FROM {competency}  WHERE id='2'");
                                                  $res2 = $DB->get_record_sql("SELECT shortname FROM {competency} WHERE id='1'");
                                                  $comp2 = $res1->shortname;
                                                  $comp3 = $res2->shortname;
